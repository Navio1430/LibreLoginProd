 ...
 * @param <I> The interface type used to talk to the database. For example, {@link
 *     java.sql.Connection} for SQL databases.
 * @author kyngs
 */
public interface DatabaseConnector<E extends Exception, I> {
    ...
    /**
     * Runs a query on the database and handles the exception. <br>
